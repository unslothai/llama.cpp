...
static void ggml_cuda_get_rows_switch_src0_type(
    ...
    switch (src0_type) {
        ...
        case GGML_TYPE_IQ1_XS:
            get_rows_cuda_kq<32, dst_t, dequantize_iq1_xs<dst_t>>(src0_d, src1_d, dst_d,
                ne00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            break;
        case GGML_TYPE_IQ1_XXS:
            get_rows_cuda_kq<32, dst_t, dequantize_iq1_xxs<dst_t>>(src0_d, src1_d, dst_d,
                ne00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            break;
        case GGML_TYPE_IQ1_XXXS:
            get_rows_cuda_kq<32, dst_t, dequantize_iq1_xxxs<dst_t>>(src0_d, src1_d, dst_d,
                ne00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            break;
